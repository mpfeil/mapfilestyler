...
Ext.define('Ext.ux.colorpicker.ColorPickerField', {
  ...
  checkColorForLabel: function(picker, value){
    var rgb = picker.hexToRgb(value);
    var hsv = picker.rgbToHsv(rgb);
    ...
    me.setFieldStyle('color: #' + me.checkColorForLabel(picker, value));
		me.collapse();
	},
